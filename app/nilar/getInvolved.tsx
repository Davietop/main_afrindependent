"use client"
import { FaShareAlt, FaEnvelopeOpenText, FaBullhorn, FaHandshake, FaDonate } from "react-icons/fa";
  ...
  <div className="max-w-5xl mx-auto px-4 text-center ">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
      {[{
        ...
        icon: <FaEnvelopeOpenText className="text-yellow-500 text-2xl mt-1" />,
        title: "Stay Informed",
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600 text-base dark:text-gray-300 mb-2">{item.text}</p>
            <Button variant="link" className="text-yellow-600 p-0 text-base">{item.cta}</Button>
          </div>
        </motion.div>
      ))}
    </div>
    ...
    >
      <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-4 font-bold">
        Africa’s economic liberation depends on principled action. Help us build
        the foundation. Share the Nilar vision.
      </p>
    </motion.div>
  </div>
</section>
