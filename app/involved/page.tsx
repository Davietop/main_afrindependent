...
export default function GetInvolvedSection() {
  return (
    <main className={`${ibmPlexSans.className}`}>
      ...
      <section className="bg-white dark:bg-[#0b1a14] px-6 sm:px-10 lg:px-24 py-24 ">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-[#002813] dark:text-[#bbbbbb] text-lg leading-relaxed">
            The Afrindependent Institute is more than a think tank—it’s a
            movement for African truth, justice, and sovereignty. Whether you’re
            an individual, organization, or institution, there are powerful ways
            you can join and amplify the work.
          </p>
        </div>
        {/* AMBASSADORS SECTION */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          <div className="bg-[#002813] dark:bg-[#173329] p-8 rounded-3xl shadow-md border border-[#ffd700] transition hover:shadow-lg">
            ...
            <p className="text-white dark:text-[#e2e2e2] mb-5">
              Help us expand research, produce publications, and reach wider
              audiences. Your contribution fuels independent African scholarship
              and the development of principled alternatives.
            </p>
            <a
              href="/donate"
              className="text-[#ffd700] hover:underline font-medium transition"
            >
              Donate Now →
            </a>
          </div>
          ...
          <div className="bg-[#002813] dark:bg-[#173329] p-8 rounded-3xl shadow-md border border-[#ffd700] transition hover:shadow-lg">
            ...
            <p className="text-white dark:text-[#e2e2e2] mb-5">
              Use your voice to share our mission. Download social media assets,
              quote cards, or email links to help us reshape the conversation
              about African development and global justice.
            </p>
          ...
          <div className="bg-[#002813] dark:bg-[#173329] p-8 rounded-3xl shadow-md border border-[#ffd700] transition hover:shadow-lg">
            ...
            <p className="text-white dark:text-[#e2e2e2] mb-5">
              Bring Africonomics to your conference, classroom, institution, or
              media platform. We offer keynotes, lectures, and briefings on
              economic sovereignty, sound money, and postcolonial justice.
            </p>
            <a
              href="/contact"
              className="text-[#ffd700] hover:underline font-medium transition"
          ...
          <div className="bg-[#002813] dark:bg-[#173329] p-8 rounded-3xl shadow-md border border-[#ffd700] transition hover:shadow-lg">
            ...
            <p className="text-white dark:text-[#e2e2e2] mb-5">
              Have skills in research, media, design, policy, or translation?
              Want to partner institutionally? We welcome collaborators aligned
              with our mission and ready to contribute meaningfully.
            </p>
            <a
              href="/contact"
              className="text-[#ffd700] hover:underline font-medium transition"
      ...
      <section
        id="submit"
        className="px-5  lg:px-10 bg-white mb-8  pb-16  text-deepForest"
      >
        <div className="mb-8 ">
          <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-deepForest text-center  pl-4">
            Article Submissions
          </h3>
          <p className="text-base ml-4 lg:text-lg text-gray-700 mb-4 text-center">
            Share your voice. Shape the future.
          </p>
          <p className="ml-4 text-base lg:text-lg  text-gray-700 mb-6 text-center">
            At the{" "}
            <span className="font-semibold">Afrindependent Institute</span>, we
            believe in the power of principled ideas to change societies. If
            you’re an aspiring or established writer, scholar, or thinker with
            bold insights grounded in truth, liberty, sound money, and
            structural justice—we welcome your contribution.
          </p>
        ...
        <div className="max-w-full w-full mx-auto">
          <div className="grid md:grid-cols-2 gap-10 mb-16">
            ...
            <div className="bg-white shadow-lg rounded-xl p-6 border-t-4 border-yellow-400 flex flex-col h-full">
              ...
              <p className="text-gray-700 mb-4">
                Our flagship platform for in-depth analysis, theoretical
                exploration, and high-level commentary. The Lens publishes
                essays that challenge dominant paradigms and help shape African
                intellectual and economic sovereignty.
              </p>
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4">
                ...
                <li>
                  Africonomics-based critiques of global governance, aid, or
                  finance
                </li>
              </ul>
              <div className="mt-auto text-sm text-gray-600">
                <p>
                  <span className="font-semibold">Word count:</span> 1,500–4,000
                  words
                </p>
                <p>
                  <span className="font-semibold">Tone:</span> Analytical,
            ...
            <div className="bg-white shadow-lg rounded-xl p-6 border-t-4 border-yellow-400 flex flex-col h-full">
              ...
              <p className="text-gray-700 mb-4">
                A space for shorter reflections, topical commentary, and
                thought-provoking takes on current events, policies, or public
                debates. Designed to spark engagement and invite principled
                perspectives rooted in the Africonomics worldview.
              </p>
              <div className="mt-auto text-sm text-gray-600">
                <p>
                  <span className="font-semibold">Word count:</span> 600–1,500
                  words
                </p>
                <p>
                  <span className="font-semibold">Tone:</span> Accessible,
          ...
          {/* How to Submit */}
          <div
            id="submitSpeakingRequest"
            className="bg-white p-6 rounded-xl shadow border-l-4 border-yellow-400 mb-12"
          >
            <h3 className="text-2xl font-semibold mb-4">How to Submit</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>
                Send your article as a Word or Google Doc to:{" "}
                <a
                  href="mailto:submissions@afrindependent.org"
                  className="text-blue-600 underline"
                >
                  submissions@afrindependent.org
                </a>
              </li>
              <li>
                Include a short bio (max 100 words) and a preferred author photo
                (optional)
              </li>
              <li>
                Indicate whether your piece is intended for{" "}
                <strong>The Lens</strong> or <strong>The Post</strong>
              </li>
            </ul>
            <p className="mt-4 text-sm text-gray-600">
              All submissions are reviewed by our editorial team. Accepted
              pieces will be lightly edited in collaboration with the author. We
              aim to respond within 10–14 business days.
            </p>
          </div>

          {/* Closing Statement */}
          <div className="text-center">
            <h4 className="text-xl font-semibold mb-2 text-deepForest">
