...
<section className={`py-20 px-4 bg-white dark:bg-[#0f1c16] text-[#002813] dark:text-white ${ibmPlexSans.className}`}>
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Our video content brings the principles of Africonomics to motion—breaking down complex ideas,
            exposing unjust systems, and presenting bold solutions for Africa and the world.
          </p>
          <p className="text-base text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-10">
            From short explainers to full-length lectures and policy breakdowns, these videos are crafted to educate,
            challenge, and inspire a new generation of African thinkers, leaders, and builders.
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-semibold mb-2">First Video Coming Soon</h3>
