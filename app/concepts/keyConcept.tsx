...
const clusters = [
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        intro:"The universal moral standard for human decisions, actions, relations, and institutions. ",
        description: "Africonomics affirms the existence of objective, universal moral principles—truth, justice, and nonaggression—as the foundation for all legitimate social and economic systems. It offers a natural-moral law framework that reorients socioeconomic systems toward liberty, dignity, and structural justice.\n\nThis framework asserts objective ethical standards that exist to guide human relations and social, legal, and economic systems—forming a universal standard for justice.",
      },
      {
        id: "african-worldview",
        title: "The African Worldview",
        intro: "A distinctly human and principled conception of human nature, relations, and interdependence.",
        description: "Unlike the prevailing Western Darwinian worldview, which is animalistic, racial, rivalrous, and aggressive, the African worldview is theist, principled, and nonrivalrous. It emphasizes humankind’s oneness, dignity, moral agency, and peaceful collaboration and coexistence, not aggression and domination. The African worldview underpins Africonomics’ rejection of Western fundamentally animalistic assumptions of human nature and relations.",
      },
      {
        id: "civilization-redefined",
        title: "Human Civilization Redefined",
        intro:"True civilization is moral, not merely material.",
        description: "This framework challenges the dominant Western definition and conception of human civilization and the West’s claim to civilizational superiority. It redefines human civilization beyond material progress as the development of just, peaceful, and humane systems—not domination through technology, force, or empire.\n\nAs social philosopher and economist Manuel Tacanho writes, “A system built on force and fraud cannot be civilized.",
      },
      {
        id: "decolonizing-knowledge",
        title: "Decolonizing Knowledge",
        intro:"Liberating African thought from Western dominance and deception.",
        description: " Africonomics calls for a principled reexamination of mainstream economics, political theory, and social science—restoring truth and intellectual sovereignty to African nations.",
      },
      {
        id: "natural-social-order",
        title: "The Natural Social Order",
        intro:"A peaceful order built on natural-moral law and individual rights",
        description: "A socioeconomic system is most peaceful, civilized, and beneficial to the extent that it aligns with the universal moral principles of truth, justice, and nonaggression. This concept articulates a vision for structuring social life ethically—without centralized and technocratic statist systems of coercion, repression, and dispossession.",
      },
    ],
  },
  {
    ...
    concepts: [
      {
        ...
        intro: "Life, liberty, and ownership—endowed by the Creator, not granted by the state.",
      ...
      },
      {
        ...
        description: "Africonomics defines justice not primarily as fairness or equality but as a society structured in alignment with natural rights, truth, and nonaggression. Structural justice requires legal, political, and economic systems that consistently uphold liberty, sound money, voluntary exchange, and ethical governance."
      },
      {
        id: "rule-of-just-law",
        title: "The Rule of Just Law",
        intro: "Law must protect rights—not impose domination.",
        description: "Africonomics questions the rule of law and rejects arbitrary rule by law, a hallmark of past and present statist systems. Instead, it upholds and calls for the rule of just law: legal frameworks grounded in natural-moral law that protect individual rights, prohibit force and fraud, minimize injustice, foster structural justice, and ensure that governments remain servants—not tyrannical masters—of the people."
      }
    ]
  },
  {
    ...
    concepts: [
      {
        ...
        description: "Africonomics defines sound money as money that arises naturally in the marketplace, retains its purchasing power over time, and is free from manipulation by states or central banks. Combined with free-market banking principles, it provides a structurally just monetary order.\n\nFor Africa, Africonomics offers the Nilar, a gold-based currency system designed to restore monetary justice, sovereignty, and economic stability."
      },
      {
  ...
  },
  {
    ...
    concepts: [
               
      {
        ...
        description: "Africonomics affirms that voluntary exchange across borders fosters peace, prosperity, and social harmony. It distinguishes true free trade from state-managed trade and calls on Africa to restore its historic tradition of free enterprise and free trade grounded in justice and mutual respect.\n\nWhile the West has failed to foster a global order based on free enterprise, free trade, and sound money—primarily due to its racial, rivalrous, and aggressive Darwinian worldview—Africa must move in the opposite direction and adopt Africonomics to rise and lead by example."
      },
      {
        id: "technocracy-vs-human-economy",
        title: "Technocracy vs the Human Economy",
        intro: "When technocratic experts replace ethics, the economy falters, and society suffers.",
        description: "This entry critiques the rise of technocracy: the rule of social engineers and mathematical economists detached from ethical and civilizational principles. Africonomics offers a human-centered alternative—an economy aligned with human nature, agency, natural rights, and reality rather than mechanical models and abstract metrics.\n\nThe economy is not a separate, mechanical system—it is society itself, composed of human lives, pursuits, and relations. Attempts to manage it technocratically are inherently unjust and ruinous."
      },
      {
        id: "economics-refined",
        title: "Economics Refined",
        intro: "Restoring truth, ethics, and clarity to the leading social science.",
        description: "Africonomics refines economics by returning it to its rightful foundation: the ethical study of human choices, actions, relations, and institutions. It rejects utilitarianism, positivism, and materialism in favor of a natural-moral framework that recognizes the existence of objective, universal moral principles and prioritizes justice, liberty, and voluntary cooperation.\n\nA New and Constructive Definition of Economics:\n\nEconomics is a social science whose fundamental purpose is to study and understand socioeconomic phenomena to foster justice, prosperity, and peaceful human relations within and among societies.",
       
      },
      {
        id: "scale-of-statism",
        title: "The Scale of Statism",
        intro: "A framework for understanding and ranking socioeconomic systems.",
        description: "This concept introduces a principled and constructive framework for evaluating socioeconomic systems—not by ideological label, but by their nature: the degree of state control, coercion, centralization, technocratic management, and redistribution they impose. Africonomics classifies systems by their structural integrity, not their slogans—from the freest to the most oppressive.",
      
        stages: [
          {intro: "The Six Stages of Statism "},
          {
            stage: "Stage 1 – Free-Market Capitalism  (or Free-Market Economy)",
            description: "A just, peaceful, and civilized system rooted in voluntary exchange, individual rights, sound money, and minimal state interference."
          },
          {
            stage: "Stage 2 – Crony Capitalism",
            description: "Markets still exist, but political favoritism and corporate-government collusion distort competition, create winners and losers, and undermine free enterprise and justice. This is where statism and systemic corruption begin."
          },
          {
            stage: "Stage 3 – Mixed Economy  (Social Market Economy)",
            description: "The state plays a substantial role in guiding and managing economic life through regulation, taxation, and government spending."
          },
          {
            stage: "Stage 4 – Economic Fascism",
            description: "Authoritarian control intensifies. The state heavily directs economic activity, though nominal private ownership remains. This system is more noticeably centralized, confiscatory, and repressive."
          },
          {
            stage: "Stage 5 – Democratic Socialism",
            description: "Extensive state ownership and redistribution under a democratic façade. High taxes, large welfare states, central planning, and openly authoritarian governance prevail."
          },
          {
            stage: "Stage 6 – Marxist Socialism (Totalitarianism)",
            description: "The most centralized, oppressive, and violent system. Individual rights and private property are abolished as the state controls nearly all economic and personal life, often with a cult of personality surrounding its leaders."
          }
        ],
        closing:"The Scale of Statism has dispelled a central global myth by demonstrating that contrary to the established belief, the United States, other Western nations, and the current global order are not free-market capitalist systems. In reality, they are heavily statist systems—closer to socialism than to free-market capitalism."
      }, 
    ]
  },
  {
  ...
  return (
   ...
   <motion.section
    ...
    >
      ...
      <p className="max-w-5xl mx-auto text-gray-700 text-base md:text-lg leading-relaxed">
        This section presents the key concepts, frameworks, and theories that define our work—from foundational ideas
        like natural-moral law and the African worldview to deep critiques of fiat money, statism, and technocracy, to
        fully developed Africonomics theories of money, economic cycles, and international relations.
      </p>
      <p className="max-w-5xl mx-auto text-gray-700 text-base md:text-lg leading-relaxed">
          ...
          {clusters.map((cluster) => (
            <button
              ...
              className={`text-left p-2 rounded-lg transition ${
                activeId === cluster.id ? "bg-deepForest text-white" : "hover:bg-gray-100"
              }`}
            >
              {cluster.title}
            </button>
      ...
      <div className="flex-1 relative">
        ...
        {searchTerm && (
          <div className="p-6 space-y-6">
            <h2 className="text-xl font-bold text-deepForest">Search Results:</h2>
            ...
            {filteredConcepts.length > 0 ? (
              filteredConcepts.map((concept) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-2 italic ">{concept.intro}</p>
                  <p className="text-gray-600">{concept.description.slice(0, 150)}...</p>
                </motion.div>
              ))
            ) : (
