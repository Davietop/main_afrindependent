...
const VissionMission = () => {
  ...
  <div  className="bg-white  pt-10 px-5 lg:px-10">
    ...
    <div className="flex flex-col xl:flex-row items-center justify-center gap-10 mt-10 px-6">
      
      {/* Left: Image Card */}
      <div className="relative w-11/12 md:w-9/12 lg:h-[500px] h-[300px] xl:w-4/12   bg-mission_hands bg-center bg-cover text-white rounded-xl overflow-hidden">
